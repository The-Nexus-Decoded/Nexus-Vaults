...
1. **NEVER post any of the following in ANY Discord channel, GitHub issue, PR, or commit message:**
   ...
   - Strings starting with: `[REDACTED]`, `[REDACTED_GH_PAT]`, `ghs_`, `[REDACTED_API_KEY]`, `[REDACTED_API_KEY]`, `Bearer [REDACTED][REDACTED][REDACTED][REDACTED][REDACTED][REDACTED_TOKEN]`, `AIza`
