...
class KillSwitch:
    ...
    def trigger(self, reason: str):
        ...
        [REDACTED_DYNAMIC_KEY] Immediate exit if critical
        [REDACTED_DYNAMIC_KEY] sys.exit(1) [REDACTED_DYNAMIC_KEY] We might want a graceful halt first, but this is the ultimate safeguard.
...
[REDACTED_DYNAMIC_KEY] Singleton instance for the executor
