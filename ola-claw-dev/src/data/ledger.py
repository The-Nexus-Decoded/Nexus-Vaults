...
class LedgerDB:
    ...
    def _get_connection(self):
        [REDACTED_DYNAMIC_KEY] Using check_same_thread=False because the state machine is async
    ...
    def _init_db(self):
        ...
        with self._get_connection() as conn:
            ...
            [REDACTED_DYNAMIC_KEY] 1. Positions Table: Current holdings
            cursor.execute("""
            ...
            [REDACTED_DYNAMIC_KEY] 2. Trade History: Audit log of all actions
            cursor.execute("""
    ...
    def record_trade(self, trade_data: Dict[str, Any]):
        ...
        with self._get_connection() as conn:
            ...
            [REDACTED_DYNAMIC_KEY] Insert into history
            cursor.execute("""
            ...
            [REDACTED_DYNAMIC_KEY] Update Positions
    ...
    def _update_position_on_buy(self, cursor, trade_data, timestamp):
        [REDACTED_DYNAMIC_KEY] Simple average entry price calculation
        ...
        if row:
            ...
            [REDACTED_DYNAMIC_KEY] Weighted average
