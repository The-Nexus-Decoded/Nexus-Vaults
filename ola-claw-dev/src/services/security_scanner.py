...
class AntiRugScanner:
    ...
    def __init__(self, profile: Dict[str, Any]):
        ...
        [REDACTED_DYNAMIC_KEY] Boolean Toggle Configuration
        ...
        [REDACTED_DYNAMIC_KEY] Threshold Configuration
    ...
    async def scan_token(self, mint_address: str) -> Dict[str, Any]:
        ...
        [REDACTED_DYNAMIC_KEY] Concurrent Fetching from both Oracles
        ...
        [REDACTED_DYNAMIC_KEY] Merged Analysis
    ...
    async def _fetch_rugcheck_baseline(self, mint: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "is_freezable": False,
            "is_lp_burned": True,
            "rugcheck_score": 0 [REDACTED_DYNAMIC_KEY] Low risk
        }
    ...
    def _perform_layered_risk_analysis(self, baseline: Dict[str, Any], gmgn: Dict[str, Any]) -> Dict[str, Any]:
        ...
        [REDACTED_DYNAMIC_KEY] --- PHASE 1: RugCheck Baseline (Authorities) ---
        ...
        [REDACTED_DYNAMIC_KEY] --- PHASE 2: GMGN Advanced (Market/Bundles) ---
