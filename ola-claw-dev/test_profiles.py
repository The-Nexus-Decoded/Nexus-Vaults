...
async def test_profiles():
    ...
    [REDACTED_DYNAMIC_KEY] 1. Test "Safe" Profile
    print("\n[TEST] Profile: SAFE")
    safe_scanner = AntiRugScanner(config["profiles"]["safe"])
    
    [REDACTED_DYNAMIC_KEY] Mocking a "bundled" but otherwise clean token
    ...
    [REDACTED_DYNAMIC_KEY] 2. Test "Aggressive" Profile
