...
async def test_exit():
    [REDACTED_DYNAMIC_KEY] Setup test DB
    ...
    [REDACTED_DYNAMIC_KEY] Simulate a position: JUP at $1.00
    ledger.record_trade({
        'action': 'BUY',
