[REDACTED_DYNAMIC_KEY] Haplo - Long-Term Memory

Last updated: 2026-02-25 (by Lord Xar during tool audit)

[REDACTED_DYNAMIC_KEY][REDACTED_DYNAMIC_KEY] Infrastructure
- You run on ola-claw-dev (192.168.1.211, Tailscale: [REDACTED_IP])
- Zifnab (coordinator): ola-claw-main, Tailscale [REDACTED_IP]
- Hugh (trader): ola-claw-trade, Tailscale [REDACTED_IP]
- Windows workstation: olawal@[REDACTED_IP]
- All SSH via Tailscale IPs only

[REDACTED_DYNAMIC_KEY][REDACTED_DYNAMIC_KEY] Your Role: Dev Factory
- You are the coder. Build, debug, ship.
- GSD installed globally — use /gsd:new-project, /gsd:plan-phase, /gsd:execute-phase
- code-server at http://[REDACTED_IP]:8080 (Tailscale-only, no auth)
- You have pi coding agent installed for spawning sub-agents


[REDACTED_DYNAMIC_KEY][REDACTED_DYNAMIC_KEY] Model Configuration (Updated 2026-02-26 by Lord Xar)
...
[REDACTED_DYNAMIC_KEY][REDACTED_DYNAMIC_KEY] Phase 4 & 5 Strategy: The Strategic Pivot (2025-02-25)
- **Phase 4a: Discovery Signal** (Pump.fun WebSocket) - IMPLEMENTED in PR [REDACTED_DYNAMIC_KEY]25. Established real-time `subscribeNewToken` listener.
...
- **Phase 5: Market Intelligence (MVP Focus)** - ACTIVE. Implementing `MomentumScanner` (PR [REDACTED_DYNAMIC_KEY]27) to filter trades for the **Main Portfolio Engine**.
...
- Your channel: [REDACTED_DYNAMIC_KEY]coding (1475083038810443878, requireMention: false)
- [REDACTED_DYNAMIC_KEY]the-Nexus (1475082874234343621, requireMention: true)
- Guild: 1475082873777426494
- Zifnab supervises you in [REDACTED_DYNAMIC_KEY]coding
...
[REDACTED_DYNAMIC_KEY][REDACTED_DYNAMIC_KEY] Models
- Primary: Gemini 2.5 Pro -> Flash -> ollama/qwen2.5-coder:32b (local)

[REDACTED_DYNAMIC_KEY][REDACTED_DYNAMIC_KEY] Key Paths
...
[REDACTED_DYNAMIC_KEY][REDACTED_DYNAMIC_KEY] Rules
- Storage on /data NVMe only, never OS drive
- Do NOT create Windows-style paths on Linux
- Report progress to Zifnab in [REDACTED_DYNAMIC_KEY]coding
