...
async def test_dashboard_logic():
    ...
    [REDACTED_DYNAMIC_KEY] Mock data for a "Bundled" token
    bundled_mock = {"is_mintable": False, "is_freezable": False, "is_lp_burned": True, "is_bundled": True, "top_10_holders_share": 10.0}

    [REDACTED_DYNAMIC_KEY] 1. Test "SafeSentinel" (Checkbox for bundle check is TRUE)
    ...
    [REDACTED_DYNAMIC_KEY] 2. Test "SniperDegen" (Master Rug Check Checkbox is FALSE)
